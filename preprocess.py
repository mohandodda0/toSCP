...
print(df_train)
df_train = execute_comm_process(df_train)[['comment_text', 'toxic']]
df_train.to_csv('traintest_processed.csv', index=False, header=False)
# Process test data
print('Comm processing test data')
df_test = pd.read_csv(input_dir + 'test.csv')
df_test = execute_comm_process(df_test)[['comment_text']]
df_test.to_csv('test_processed.csv', index=False, header=False)
